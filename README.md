...
An open-source platform with 34 multi-agent use cases, a full control plane, reference implementations, and CI/CD pipelines — ready to deploy on AWS with Amazon Bedrock AgentCore.
...
- **Reference Implementations** — End-to-end full-stack solutions with frontend, backend, and infrastructure
...
| Implementation | Domain | Stack | Description |
|---------------|--------|-------|-------------|
| [Market Surveillance](applications/reference_implementations/market-surveillance/README.md) | Capital Markets | Strands + Terraform | Real-time trade monitoring with 29 decision tree rules, multi-agent orchestration, and audit-ready reports |
| [Shopping Concierge Agent](applications/reference_implementations/shopping-concierge-agent/README.md) | Agentic Payments | Strands + CDK + Amplify | AI-powered concierge with product search, cart management, payment support, and Cognito auth |
...
| **Safety** | Agent Safety *(coming soon)* | Guardrails, cost controls, human-in-the-loop, and monitoring dashboard |
...
│   │   │
│   │   └── agent-safety/                        # Guardrails and safety controls
...
| Explore reference implementations | See [applications/reference_implementations/](applications/reference_implementations/README.md) |
...
| [Daniela Vargas](https://www.linkedin.com/in/daniela-vargas-msda/) | Langfuse observability, Shopping Concierge Agent reference implementation                                                                                     |
| &#8226; [Alseny Diallo](https://www.linkedin.com/in/dialloalseny/) <br/> &#8226; [Mark Paguay](https://www.linkedin.com/in/mark-paguay-5a06a6193/) | Market Surveillance reference implementation                                                                                                                  |
