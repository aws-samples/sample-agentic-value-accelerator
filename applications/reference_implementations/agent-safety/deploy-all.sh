...
#   6. Event-Driven Signals (6 Lambdas for real-time signal processing)
#   7. Sample Agent (Inference Profile + S3 + AgentCore Runtime)
#
# Usage:
...
# ============================================================
# PHASE 2e: Event-Driven Signals (Real-time signal processing Lambdas)
# ============================================================
if [ "$SKIP_COST" = false ]; then
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  echo "  ⚡ Phase 2e: Event-Driven Signals"
  echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  EDS_DIR="$SCRIPT_DIR/event-driven-signals"
  if [ -f "$EDS_DIR/deploy.sh" ]; then
    # Get SNS topic ARN from cost controls stack
    ...
    if [ -n "$SNS_ARN" ] && [ "$SNS_ARN" != "None" ]; then
      ...
      echo "  ⚠️  SNS topic ARN not found in cost controls stack — skipping"
    fi
  else
    echo "  ⏭️  Event-driven signals not found — skipping"
  fi
  echo ""
else
  echo "⏭️  Skipping event-driven signals deployment"
fi
