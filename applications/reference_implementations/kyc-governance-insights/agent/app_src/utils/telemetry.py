...
def setup_tracing() -> bool:
    ...
    #      AgentCore runtime. Framework instrumentation (LangChain)
    ...
    try:
        if langfuse_mode:
            ...
            # Set the OTEL env vars; the LangChain instrumentor picks them up.
...
def build_trace_attributes(
    ...
    """
    Build trace attributes dict for agent spans.
