...
| `FRAMEWORK_SHORT` | Short name for the framework | `langgraph` |
...
ava-kyc-langgraph-agentcore:v1.0.0
...
| `FRAMEWORK` | Yes | `langchain_langgraph` | Framework ID. Only `langchain_langgraph` ships in this reference implementation. |
