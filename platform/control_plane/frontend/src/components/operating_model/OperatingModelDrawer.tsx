...
import { buildOperatingModelReport } from './report';
      ...
      <div className="absolute right-0 top-0 bottom-0 w-full max-w-5xl bg-white shadow-2xl flex flex-col animate-slide-in-right">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          ...
          <div className="flex items-center gap-2">
            <ExportReportButton
              variant="subtle"
              title="Download this operating model as a PDF report (reflects current edits)"
              getDefinition={() => buildOperatingModelReport({
                operating_model_id: initial?.operating_model_id ?? 'draft',
                name: name.trim() || 'Untitled operating model',
                description,
                organization,
                designer,
                status,
