...
# Deploy the Control Plane backend to ECS
# Usage: ./deploy-backend.sh [--profile AWS_PROFILE] [--region REGION]
...
ECS_SERVICE="ava-control-plane-backend"
...
ECR_REPO="${ECR_REGISTRY}/ava-control-plane-backend"
...
# --- Build Docker image ---
echo "Building backend Docker image with $CLI..."
cd "$REPO_ROOT"
